...
.render(
    <div style={mainStyle}>
        <h1>Аспекты</h1>
        <p style={textStyle}>Чтобы перейти на страницу интересующего Вас аспекта, перейдите по ссылкам ниже:</p>
        <a style={mainStyle} href="will/index.html">Воля</a><br />
        <a style={mainStyle} href="logic/index.html">Логика</a><br />
        <a style={mainStyle} href="physics/index.html">Физика</a><br />
        <a style={mainStyle} href="emotion/index.html">Эмоция</a><br />
